...
const Navbar = () => {
  return (
    <div className="shadow-md bg-white dark:bg-orange-900 dark:text-white duration-200 relative  z-40">
      {/* upper Navbar */}
      <div className="bg-orange/40 py-4 ">
        <div className="container flex justify-between items-center ml-30">
          <div>
